...
=== "ParsedVar"
    Variable partially reconstructed from a csv file saved through the [.save]({{fix_url("../reference/data_structures/storers/#bgc_data_processing.data_structures.storers.Storer.save")}}) method of a Storer.
